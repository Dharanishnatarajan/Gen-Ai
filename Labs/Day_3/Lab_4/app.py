...
logger = logging.getLogger("field_notes_pipeline")
...
class RunRequest(BaseModel):
    ...
    audience: Optional[str] = Field(default="product team", max_length=MAX_FIELD_LEN)
    length: Optional[str] = Field(default="short", max_length=MAX_FIELD_LEN)
