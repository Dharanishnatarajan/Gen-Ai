...
# ─────────────────────────────────────────────
LOW_THRESHOLD  = 0.25   # score < 0.25 -> auto-approve
HIGH_THRESHOLD = 0.65   # score >= 0.65 -> auto-deny
# 0.25 <= score < 0.65 -> human_review
...
TOXIC_PATTERNS = {
    ...
    "harassment": (["shut up", "loser", "worthless", "moron"], 0.18),
    "pii":        (["credit card", "ssn", "password", "otp"], 0.22),
}
